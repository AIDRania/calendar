...
socket.on('Calendar',function(data){
  if(data.name == CALENDAR_NAME){
      ...
      else if(data.action == 'EVENT_UPDATE')notifyMe("Event has updated");
      else if(data.action == 'EVENT_DELETE')notifyMe("Event has deleted");
      $("#calendar").fullCalendar('refetchEvents');
    }
  console.log(data);
  if(data.action == 'EVENT_REMEMBER')notifyMe("Event "+data.name+" start in "+data.min+" min");
